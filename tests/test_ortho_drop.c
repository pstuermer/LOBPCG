...
TEST(d_ortho_drop_no_B) {
    ...
    d_ortho_drop(m, n_u, n_v, eps, eps, U, V, wrk1, wrk2, wrk3, NULL);
...
TEST(d_ortho_drop_with_B) {
    ...
    d_ortho_drop(m, n_u, n_v, eps, eps, U, V, wrk1, wrk2, wrk3, B);
...
TEST(z_ortho_drop_no_B) {
    ...
    z_ortho_drop(m, n_u, n_v, eps, eps, U, V, wrk1, wrk2, wrk3, NULL);
...
TEST(z_ortho_drop_with_B) {
    ...
    z_ortho_drop(m, n_u, n_v, eps, eps, U, V, wrk1, wrk2, wrk3, B);
...
int main(void) {
    ...
    printf("ortho_drop tests:\n");
    RUN(d_ortho_drop_no_B);
